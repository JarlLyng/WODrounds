...
- **Changed:** tvOS — calmer focus appearance. The default system focus drew a large white plate behind the bright buttons; buttons now use a subtle lift (gentle scale + soft shadow) instead.
